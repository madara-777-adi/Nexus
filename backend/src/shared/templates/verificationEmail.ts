                    ...
                    <tr>
                        <td align="center" style="padding: 0 40px 25px 40px;">
                            <span style="font-size: 13px; color: #64748B;">
                                ⏱️ This verification link will expire in <strong style="color: #94A3B8;">24 hours</strong>.
                            </span>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td align="center" style="font-size: 11px; color: #475569; font-family: monospace;">
                                        © ${new Date().getFullYear()} NEXUSSPACE.TECH // EMPOWERING YOUR LEARNING JOURNEY
                                    </td>
                                </tr>
                            </table>
                        </td>
